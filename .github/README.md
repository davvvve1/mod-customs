...
> [!NOTE]
> The Season of Discovery (SoD) login buff could potentially be implemented using a PTR template (see [mod-ptr-template](https://github.com/azerothcore/mod-ptr-template)). However, due to limited knowledge on how to add it via the PTR template system at this time, it has been built as a standalone module feature instead.
